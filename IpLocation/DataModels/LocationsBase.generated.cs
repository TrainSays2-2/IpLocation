...
namespace DataModels
{
	...
	public partial class Location
	{
		...
		[Column("ip"),               PrimaryKey,  NotNull] public NpgsqlInet Ip             { get; set; } // inet
		[Column("continent_id"),        Nullable         ] public int?       ContinentId    { get; set; } // integer
		[Column("country_id"),          Nullable         ] public int?       CountryId      { get; set; } // integer
		[Column("city_id"),             Nullable         ] public int?       CityId         { get; set; } // integer
		[Column("continent_name"),      Nullable         ] public string     ContinentName  { get; set; } // text
		[Column("country_name"),        Nullable         ] public string     CountryName    { get; set; } // text
		[Column("country_iso_code"),    Nullable         ] public string     CountryIsoCode { get; set; } // text
		[Column("continent_code"),      Nullable         ] public string     ContinentCode  { get; set; } // text
		[Column("city_name"),           Nullable         ] public string     CityName       { get; set; } // text
	}
	...
	{
		public static Location Find(this ITable<Location> table, NpgsqlInet Ip)
		{
